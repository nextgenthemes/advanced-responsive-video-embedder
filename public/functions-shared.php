...
function options() {
	...
	$options = wp_parse_args( get_option( 'arve_options_main', array() ), options_defaults( 'main' ) );
	...
	$options['shortcodes'] = wp_parse_args( get_option( 'arve_options_shortcodes', array() ), options_defaults( 'shortcodes' ) );
	$options['params']     = wp_parse_args( get_option( 'arve_options_params',     array() ), options_defaults( 'params' ) );
...
function register_asset( $args ) {
	...
	if ( \Nexgenthemes\ends_with( $args['src'], '.css' ) ) {
