...
Contributors: nico23
Donate link: http://my-hardware.net/plugins/advanced-resposive-video-embedder/
...
Fully resosible css for dynamically resising every video.
...
* Special mode: This will put out the video with any wrapper but with a css class for users to style themseves. Most
