...
add_action( 'init', 'arve_action_init' );

function arve_action_init() {

	add_action( 'plugins_loaded', 'arve_action_plugins_loaded' );
	add_action( 'admin_init', 'arve_action_admin_init' );
	add_action( 'admin_menu', 'arve_action_admin_menu' );
	add_action( 'wp_enqueue_scripts', 'arve_action_enqueue_scripts' );
	add_action( 'wp_print_styles', 'arve_action_wp_print_styles');
...
function arve_action_admin_init(){
...
function arve_action_admin_menu() {
...
function arve_build_embed( $id, $provider, $align = null, $mode = null, $maxwidth = null, $time = null, $autoplay = null ) {
