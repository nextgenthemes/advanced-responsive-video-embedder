...
/* harmony import */ var _settings_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./settings.scss */ "./plugins/advanced-responsive-video-embedder/src/settings.scss");
...
new (vue__WEBPACK_IMPORTED_MODULE_1___default())({
  ...
  methods: {
    ...
    // end: saveOptions
    resetOptions() {
      let tag = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'all';
      if ('all' === tag) {
