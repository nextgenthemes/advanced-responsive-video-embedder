...
<div class="wrap">
	...
	<div class="updated">
		<p><big><?php echo $this->get_admin_message(); ?></big></p>
	</div>
			...
			<tr valign="top">
				...
				<td>
					<select id="arve_options[mode]" name="arve_options[mode]" size="1">
						...
						<option<?php selected( $this->options['mode'], 'thumbnail'); ?> value="thumbnail"><?php _e('Thumbnail -> Colorbox', $this->plugin_slug ); ?></option>
					</select>
				</td>
			</tr>
			<tr valign="top">
